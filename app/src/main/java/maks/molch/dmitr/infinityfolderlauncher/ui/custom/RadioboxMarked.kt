...
val Icons.RadioboxMarked: ImageVector
    get() {
        ...
        _RadioboxMarked = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF5E5E5E))) {
                ...
                close()
                moveTo(12f, 7f)
                curveTo(10.674f, 7f, 9.402f, 7.527f, 8.464f, 8.464f)
                curveTo(7.527f, 9.402f, 7f, 10.674f, 7f, 12f)
                curveTo(7f, 13.326f, 7.527f, 14.598f, 8.464f, 15.535f)
                curveTo(9.402f, 16.473f, 10.674f, 17f, 12f, 17f)
                curveTo(13.326f, 17f, 14.598f, 16.473f, 15.535f, 15.535f)
                curveTo(16.473f, 14.598f, 17f, 13.326f, 17f, 12f)
                curveTo(17f, 10.674f, 16.473f, 9.402f, 15.535f, 8.464f)
                curveTo(14.598f, 7.527f, 13.326f, 7f, 12f, 7f)
                close()
            }
        }.build()
